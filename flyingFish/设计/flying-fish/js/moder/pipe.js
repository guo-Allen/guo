...
(function( w ) {
    ...
    * */
    function Pipe( options ) {
        ...
        // 管道每秒运行的速度
        this.speedSecond = options.speedSecond;
    ...
    Pipe.prototype = {
        ...
        // 绘制管道对应的冰柱路径
        drawPath: function() {
        	this.ctx.moveTo(this.x,this.downY);
        	this.ctx.lineTo(this.x+this.imgWidth/2,this.downY+this.imgHeight);
        	this.ctx.lineTo(this.x+this.imgWidth,this.downY)
        	       	       	
        	this.ctx.moveTo(this.x+this.imgWidth/2,this.upY);
        	this.ctx.lineTo(this.x, this.upY+this.imgHeight);
        	this.ctx.lineTo(this.x+this.imgWidth,this.upY+this.imgHeight);
